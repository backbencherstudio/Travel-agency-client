        ...
        <table className="w-full table-auto min-w-[768px]">
          <thead className="bg-[#F9FAFB] text-[#475467] text-[12px]">
            <tr className="text-nowrap">
              ...
              <th className="p-6 font-medium">Code status</th>
              <th className="p-6 font-medium">Restricted usage</th>
              <th className="p-6 rounded-r-lg font-medium">Action</th>
            </tr>
          </thead>
          <tbody>
            {isLoading ? (
              ...
              filteredData?.map((item) => (
                ...
                >
                  ...
                  <td className="p-6 flex items-center gap-[10px]">
                    ...
                    >
                      <path
                        d="M17.6099 8.21124C18.5762 9.22797 18.5762 10.7727 17.6099 11.7894C15.9801 13.5042 13.1809 15.8337 10.0013 15.8337C6.82171 15.8337 4.02255 13.5042 2.39272 11.7894C1.42638 10.7727 1.42638 9.22797 2.39272 8.21124C4.02255 6.49644 6.82171 4.16699 10.0013 4.16699C13.1809 4.16699 15.9801 6.49644 17.6099 8.21124Z"
                        stroke="#475467"
                        stroke-width="1.5"
                      />
                      <path
                        d="M12.5013 10.0003C12.5013 11.381 11.382 12.5003 10.0013 12.5003C8.62059 12.5003 7.5013 11.381 7.5013 10.0003C7.5013 8.61961 8.62059 7.50033 10.0013 7.50033C11.382 7.50033 12.5013 8.61961 12.5013 10.0003Z"
                        stroke="#475467"
                        stroke-width="1.5"
                      />
                    </svg>
