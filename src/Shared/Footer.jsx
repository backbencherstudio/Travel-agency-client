    ...
    {link.name.toLowerCase() === "facebook" && (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 30 24" fill="none">
        ...
        <g clipPath="url(#clip0_5494_555)">
          <path d="M19.7562 4.36653H22.3645V0.732241C21.9145 0.682718 20.3669 0.571289 18.5645 0.571289C14.8038 0.571289 12.2276 2.46367 12.2276 5.94177V9.14272H8.07764V13.2056H12.2276V23.4284H17.3157V13.2065H21.2979L21.93 9.14367H17.3145V6.34462C17.3157 5.17034 17.711 4.36653 19.7562 4.36653Z" fill="#1D1F2C"/>
        </g>
        <defs>
          <clipPath id="clip0_5494_555">
            <rect width="28.5714" height="22.8571" fill="white" transform="translate(0.714355 0.571289)"/>
          </clipPath>
        </defs>
      </svg>
    )}
    ...
    {link.name.toLowerCase() === "twitter" && (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 26 20" fill="none">
        ...
        <g clipPath="url(#clip0_5494_565)">
          <path d="M15.3241 8.46864L24.4308 0H22.2728L14.3655 7.3532L8.04989 0H0.765625L10.316 11.1193L0.765625 20H2.92374L11.2741 12.2348L17.9438 20H25.2281L15.3236 8.46864H15.3241ZM12.3683 11.2173L11.4006 10.1101L3.70134 1.29967H7.01608L13.2295 8.40994L14.1971 9.51718L22.2738 18.7594H18.9591L12.3683 11.2177V11.2173Z" fill="#1D1F2C"/>
        </g>
        <defs>
