  ...
  return (
    <div>
        <div className="flex my-5 justify-between items-center">
            <h1 className="font-semibold text-[18px] md:text-[24px]">Travel Packages</h1>
            <Link
            ...
            <div className='flex flex-col gap-5 md:col-span-2 xl:col-span-3'>
                ...
                <div className='flex flex-col gap-2'>
                    <div className='flex gap-[6px]'>
                        ...
                        <p className='text-sm text-[#333E47]'>{singlePackage?.destination?.name}, {singlePackage?.destination?.country?.name}</p>
                    </div>
                    <div className='flex gap-[6px]'>
                        <div className='flex gap-[6px] w-28'>
                        ...
                        {singlePackage?.package_tags
                            ...
                            .map((include, index) => (
                                <div className="flex gap-2" key={index}>
                                    ...
                                    <p className="text-sm font-normal text-[#4A4C56]">{include?.tag?.name}</p>
                                </div>
                        ))}
                    </div>
                </div>
            ...
            <div className='px-4 py-5 border-t border-l border-r rounded-t-lg'>
                ...
                {packages.map((pack, index) =>
                    <div key={index} className='p-3 flex flex-col gap-3 cursor-pointer' onClick={() => handleNavigate(pack.id)}>
                        ...
                        <p className='text-xs font-normal text-[#475467]'>{truncateDescription(pack.description)}</p>
                    </div>
                )}
            </div>
        </div>
