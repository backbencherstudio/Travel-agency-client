...
const PackageDestination = () => {
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, data }) =>
      axiosClient.patch(`/api/admin/destination/${id}`, data),
    onSuccess: () => {
      refetch();
      reset();
      setImages([]);
  ...
  const onSubmit = async (data) => {
    ...
    form.append("latitude", Number(data?.latitude));
    form.append("longitude", Number(data?.longitude));
  ...
  const handleEdit = (category) => {
    ...
    setValue("latitude", category?.latitude || "");
    setValue("longitude", category?.longitude || "");
  };
                    ...
                    {data?.data
                      ...
                      ?.map((category, index) => (
                        <TableRow key={category.id}>
                          ...
                          <TableCell>{category.latitude}</TableCell>
                          <TableCell>{category.longitude}</TableCell>
                          <TableCell>
                            <div className="flex">
                              <button
                                type="button"
