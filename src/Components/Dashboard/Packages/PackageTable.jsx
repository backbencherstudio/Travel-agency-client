...
const PackageTable = ({ tableType = '', title, columns, refetch, showAction, data }) => {
                    ...
                    {(columns?.action && showAction) && (
                      <td className='px-3'>
                        <div className='relative flex items-center w-fit'>
                          ...
                          <div onClick={e => handlePackageDelete(e, item.id)} className={`flex w-fit gap-3 p-3 rounded-md font-medium text-[#4A4C56] cursor-pointer`}>
