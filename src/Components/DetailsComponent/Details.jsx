          ...
          <div className="flex flex-col gap-[30px]">
            ...
            <div className="flex flex-col gap-5">
              <div className="pt-[30px] flex flex-col gap-5 text-[#0F1416]">
                ...
                {tripPlan.map((plan) => (
                  <div className="relative flex flex-col gap-1 border-l border-[#FDEFEA] pl-8">
      ...
      <div className="flex flex-col gap-12">
        ...
        <div className="flex gap-6 relative">
          {topReviews.map((review) => (
            <div
              key={review.id}
              className="h-[240px] shadow-[0px_5px_30px_0px_#00000014] p-6 flex flex-col gap-4 rounded-2xl"
            >
              <div className="flex gap-3">
                <div className="flex gap-1">
                  <svg
          ...
          <div className="absolute cursor-pointer top-1/2 -translate-y-1/2 -left-[24px] text-white bg-[#F5F5F5] p-3 rounded-full">
            ...
            >
              <path
                d="M15 19.7508C14.808 19.7508 14.616 19.6778 14.47 19.5308L7.46999 12.5308C7.17699 12.2378 7.17699 11.7628 7.46999 11.4697L14.47 4.46975C14.763 4.17675 15.238 4.17675 15.531 4.46975C15.824 4.76275 15.824 5.23779 15.531 5.53079L9.06106 12.0008L15.531 18.4707C15.824 18.7637 15.824 19.2388 15.531 19.5318C15.384 19.6778 15.192 19.7508 15 19.7508Z"
                fill="#0E457D"
              />
            </svg>
          </div>
