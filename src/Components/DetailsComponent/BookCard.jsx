  ...
  return (
    <div className='flex flex-col gap-4 max-w-full'>
      ...
      <div className='flex flex-col gap-2'>
        ...
        <div className='text-sm mt-1 text-[#EB5B2A]'>
          ...
          <span className='text-xs text-[#49556D]'>
            ({details?.cancellation_policy?.policy})
          </span>
        </div>
      ...
      <button
        ...
        className='flex gap-2 items-center justify-center p-3 bg-[#EB5B2A] rounded-full text-white text-base font-medium w- mt-2'
      >
        Book Now
      </button>
    </div>
