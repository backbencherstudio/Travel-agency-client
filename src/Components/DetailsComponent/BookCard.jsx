  ...
  return (
    <>
      ...
      <div className='flex flex-col gap-4 max-w-full shadow-[0px_5px_30px_0px_#00000014] p-6 rounded-xl'>
        ...
        <div className='text-[#000] text-xl font-semibold'>Select Date and Travelers</div>
        <div>
          {/* Start Date Picker */}
          <div className='flex border items-center gap-4 p-4 rounded-md border-[#e5e6e6] shadow-sm'>

            <div onClick={() => startDatePickerRef.current.setOpen(true)}
              className='text-2xl cursor-pointer ml-2 w-fit'>
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                <path d="M3.25 7.5C3.25 5.29086 5.04086 3.5 7.25 3.5H17.25C19.4591 3.5 21.25 5.29086 21.25 7.5V18C21.25 20.2091 19.4591 22 17.25 22H7.25C5.04086 22 3.25 20.2091 3.25 18V7.5Z" stroke="#0F1416" stroke-width="1.5" />
                <path d="M3.25 9H21.25" stroke="#0F1416" stroke-width="1.5" stroke-linecap="round" />
                <path d="M8.25 2L8.25 5" stroke="#0F1416" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M16.25 2V5" stroke="#0F1416" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
          ...
          <div className='flex border mt-4 items-center gap-4 p-4 rounded-md border-[#e5e6e6] shadow-sm'>
            ...
            <div onClick={() => endDatePickerRef.current.setOpen(true)}
              className='text-2xl cursor-pointer ml-2 w-fit'>
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="22" viewBox="0 0 20 22" fill="none">
                <path d="M4.82757 14.4816C3.4128 15.324 -0.296635 17.0441 1.96266 19.1966C3.06631 20.248 4.29549 21 5.84087 21H14.6591C16.2045 21 17.4337 20.248 18.5373 19.1966C20.7966 17.0441 17.0872 15.324 15.6724 14.4816C12.3548 12.5061 8.14519 12.5061 4.82757 14.4816Z" stroke="#1D1F2C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M14.75 5.5C14.75 7.98528 12.7353 10 10.25 10C7.76472 10 5.75 7.98528 5.75 5.5C5.75 3.01472 7.76472 1 10.25 1C12.7353 1 14.75 3.01472 14.75 5.5Z" stroke="#1D1F2C" stroke-width="1.5" />
              </svg>
            </div>
        ...
        <div className='flex flex-col gap-4 text-[#49556D] bg-[#FDEFEAB2] p-4 rounded-xl'>
          <div className='flex gap-[10px]'>
            <div className='relative w-[24px] h-[24px] text-white flex gap-[10px]'>
              <input type="checkbox" checked={freeCancellation} onClick={handleFreeChancellation} class="w-6 h-6 border-2 border-gray-400 rounded-full appearance-none checked:bg-[#14AE5C] checked:border-[#14AE5C] focus:outline-none" />
              <div className='absolute top-0 flex items-center justify-center' onClick={handleFreeChancellation}>
                <svg
            ...
            <div>
              <p className='text-[#49556D] text-sm '><span className='text-[#49556D] underline cursor-pointer text-nowrap font-bold text-sm leading-5'>Free Cancellation</span> up to 24 hours before the experience starts (local time)</p>
            </div>
          </div>
          <div className='flex gap-[10px]'>
            <div className='relative w-[24px] h-[24px] text-white flex gap-[10px]'>
              <input type="checkbox" checked={payLater} onClick={handlePayLater} class="w-6 h-6 border-2 border-gray-400 rounded-full appearance-none checked:bg-[#14AE5C] checked:border-[#14AE5C] focus:outline-none" />
              <div className='absolute top-0 flex items-center justify-center' onClick={handlePayLater}>
                <svg
                  className="w-full h-full"
                  viewBox="0 0 24 24"
                  fill="none"
            ...
            <div>
              <span className='underline cursor-pointer text-[#49556D] text-nowrap text-sm font-bold'>Book Now and Pay Leter</span>
            </div>
          </div>
        </div>
      </div>
