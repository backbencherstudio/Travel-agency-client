  ...
  return (
    <div className='max-w-7xl mx-auto'>
        ...
        <div className='flex flex-col md:flex-row flex-wrap gap-6 items-center justify-center py-12'>
            <div className="relative flex flex-col my-6 bg-white shadow-md border border-slate-200 rounded-lg w-80 md:w-96">
                    ...
                    <div className='flex items-center gap-2 mt-3'>
                        ...
                        <div className="flex items-center">
                            ...
                            <div className='flex items-center'>
                                ...
                                <p className="ms-1 text-sm  text-gray-600 dark:text-gray-400">6 days</p>
                            </div>
