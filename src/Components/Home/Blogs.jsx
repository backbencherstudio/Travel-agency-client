  ...
  return (
    <div className='max-w-7xl mx-auto'>
        ...
        <div className='flex flex-col md:flex-row gap-6 items-center justify-center py-12'>
            <div class="relative flex flex-col my-6 bg-white shadow-md border border-slate-200 rounded-xl w-80 md:w-96">
                <div class="relative h-56 overflow-hidden text-white rounded-t-xl">
                    <img src={image1} alt="card-image" />
                    <div class="absolute top-0 left-0 bg-[#F5F7F9] text-[#323B47] px-3 pb-1 m-4 rounded-full text-xs font-bold">
                        Recently Added
                    </div>
                </div>
                <div class="p-4">
                    <div className='flex items-center gap-1'>
                        <div class="mb-5 bg-[#E7ECF2] text-[#0E457D] text-xs font-medium me-2 px-2.5 py-[5px] rounded-full border border-[#0E457D] dark:bg-gray-700 dark:text-gray-300">
                            5 mins read
                        </div>
                        <div class="mb-5 bg-[#FDEFEA] text-[#EB5B2A] text-xs font-medium me-2 px-2.5 py-[5px] rounded-full border border-[#EB5B2A] dark:bg-gray-700 dark:text-gray-300">
                            Jan 6, 2024
                        </div>
                    </div>
