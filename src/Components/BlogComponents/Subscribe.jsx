...
const Subscribe = () => {
    return (
        <div className="grid lg:grid-cols-2 md:gap-16 bg-[#0E457D] px-2 md:px-10 py-6 rounded-lg mb-8 text-white ">
            <div >
                <h2 className=" text-[30px] md:text-[48px] font-bold leading-[100%] tracking-[0.12px] font-open-sans mt-6 mb-4">Subscribe to our blog</h2>
                ...
                <div className="flex justify-between py-2 pl-4 pr-2 border-[0.5px] border-[#8f8f8f] rounded-lg bg-[#FFFFFF] mt-5 ">
                    ...
                    <div className="flex gap-[6px] px-4 py-2 bg-[#0E457D] items-center rounded-md">
                        <button className='lg:py-1'>Subscribe</button>                        
                    </div>
                </div>
            </div>
            <div>
