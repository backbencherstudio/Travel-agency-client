...
const TourBook = ({ tour, renderStars }) => {
  ...
  return (
    <div className='flex flex-col gap-4'>
        <h1 className='text-[40px] font-bold border-b border-b-[#e5e6e6] pb-[15px]'>${tour?.price}<span className='text-lg font-normal'>/per person</span></h1>
        <div>
            {/* Start Date Picker */}
        ...
        <div className='flex flex-col gap-2'>
            ...
            <div className='flex flex-col gap-4'>
                ...
                <div className='flex items-center gap-3'>
                    ...
                    <p className='text-base font-normal text-[#49556D]'>Breakfast included </p>
                </div>
                <div className='flex items-center gap-3'>
                    <input
                        type="checkbox"
                        ...
                        // }
                    />
                    <p className='text-base font-normal text-[#49556D]'>All inclusive </p>
                </div>
                <div className='flex items-center gap-3'>
                    <input
                        type="checkbox"
                        ...
                        // }
                    />
                    <p className='text-base font-normal text-[#49556D]'>Dinner included </p>
                </div>
                <div className='flex items-center gap-3'>
                    <input
                        type="checkbox"
                        ...
                        //     }))
                        // }
                    /> <p className='text-base font-normal text-[#49556D]'>Lunch included </p>
                </div>
            </div>
        </div>
    </div>
